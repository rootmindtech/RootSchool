...
public class AES128Crypto extends Helper {
    ...
    public  String md5DB(String input, String schoolID) throws Exception {
        ...
        try {
        		...
        		if(input!=null)
        		{
        			con = getConnection();  
		        	//----
					sql="SELECT AESSaltKey from MST_Parameter where SchoolID=?";
 ...
 public  String md5Manual(String input) throws Exception {
  ...
  public String encryptPasswordDB(String valueToEnc, String schoolID) throws Exception {
		...
		try{
				...
				//----
				sql="SELECT AESEncryptKey from MST_Parameter where SchoolID=?";
			...
			encryptedValue=md5DB(encryptedValue, schoolID);
