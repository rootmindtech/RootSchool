...
public class TestMessage {
	...
	public void Test() {
		...
		String finalStudentID = schoolCode + dmyFormat.format(new java.util.Date()).toUpperCase()
				+ String.format("%0" + 5 + "d", studentId);
	...
	public static void main(String args[]) {
		...
		String surveyData = "Ram|Lee|26/09/2016|EastGodavari";
		String[] resultArray = surveyData.split("\\|");
